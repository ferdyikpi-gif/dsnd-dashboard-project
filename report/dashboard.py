# --- RUNTIME FIX FOR INSTRUCTOR BASE FILES ---
import fasthtml.common
if not hasattr(fasthtml.common, 'Group'):
    fasthtml.common.Group = fasthtml.common.Div
# ---------------------------------------------
...
class ReportDropdown(Dropdown):
    ...
    def component_data(self, entity_id, model):
        ...
        # names and ids
        data = model.names()
        return [(str(row[1]), str(row[0])) for row in data]
